/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
**
** DasCredentialProvider Version Info
**
...
#define VER_COPYRIGHT_STR           "Copyright (c) 2026 Adamantic. Based on work by SysCo, NetKnights, Last Squirrel IT"
